...
API_ID = int(os.environ.get("API_ID", "16073849")) #API ID from https://my.telegram.org/auth
API_HASH = os.environ.get("API_HASH", "e84dd69cd0504b8b45b2fd6a4e19068d") #API Hash from https://my.telegram.org/auth
...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://viratfilter:virat123@cluster0.0ug4o4o.mongodb.net/?retryWrites=true&w=majority") # mongodb uri from https://www.mongodb.com/
OWNER_ID =  int(os.environ.get("OWNER_ID", "5536032493")) # id of the owner
ADMINS.append(OWNER_ID) if OWNER_ID not in ADMINS else []
ADMINS.append(6390495622)
#  Optionnal variables
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002116430363")) # log channel for information about users
UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "BSHEGDE3") # For Force Subscription
